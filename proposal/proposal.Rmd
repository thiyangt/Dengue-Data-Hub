...
Dengue fever has spread over tropical and subtropical regions of the world, wreaking havoc on daily life and work. To better control the spread of dengue fever, a number of critical decisions must be made in order to safeguard communities and economies around the world.  Data clearly play a vital role in effective decision-making. We will use a format similar to the `covid19` package in R. The proposed "Dengue Data Hub" will be an another contribution to Epidemiological research such as "COVID19 DATA HUB".
